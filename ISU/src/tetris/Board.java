...
public class Board extends JPanel implements KeyListener,ActionListener{
	...
	private void createIShape() {
		shapes.add(new IShape(95,30)); 
		shapes.add(new IShape(110,30));
		shapes.add(new IShape(125,30));
		shapes.add(new IShape(140,30));	
	}
	private void createOShape() {
		shapes.add(new OShape(95,30));
		shapes.add(new OShape(110,30));
		shapes.add(new OShape(95,45));
		shapes.add(new OShape(110,45));
	}
